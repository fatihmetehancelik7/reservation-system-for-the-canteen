                ...
                {!isAdmin && (
                    <Card title="Hızlı İşlemler">
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            <Link to="/monthly-selection" className="btn btn-primary" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', justifyContent: 'center' }}>
                                <Calendar size={20} />
                                Yeni Aylık Rezervasyon Yap
                            </Link>
                            <Link to="/my-payments" className="btn btn-secondary" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', justifyContent: 'center' }}>
                                <CreditCard size={20} />
                                Ödeme Geçmişim
                            </Link>
                        </div>
